  ...
  return (
    <div className="flex flex-col items-center gap-6 p-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-foreground mb-2">🃏 Blackjack</h2>
        <p className="text-sm text-muted-foreground">Get closer to 21 than the dealer!</p>
      </div>

      {/* Game Area */}
      <div className="w-full max-w-md p-6 bg-green-900/30 rounded-2xl border border-green-600/30">
        {/* Dealer Hand */}
        <div className="mb-8">
      ...
      <div className="w-full max-w-xs space-y-4">
        ...
        {gameState === 'playing' && (
          <div className="flex gap-3">
            <Button onClick={hit} className="flex-1 h-12 font-bold">
              Hit
            </Button>
            <Button onClick={() => stand()} variant="secondary" className="flex-1 h-12 font-bold">
              Stand
            </Button>
          </div>
        )}
        ...
        {gameState === 'result' && (
          <Button onClick={newRound} className="w-full h-12 font-bold">
            New Hand
          </Button>
        )}
      </div>
